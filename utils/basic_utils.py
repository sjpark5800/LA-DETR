...
def l2_normalize_torch_tensor(tensor, eps=1e-5):
    """
    Normalize the last dimension of the input tensor using L2 norm.

    Args:
        tensor (torch.Tensor): The input tensor with shape (*, D).
